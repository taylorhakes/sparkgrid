(function() {
  ...
  function DataView(options) {
    ...
    // events
    var onRowCountChanged = new core.Event();
    var onRowsChanged = new core.Event();
    var onPagingInfoChanged = new core.Event();

    options = core.extend(true, {}, defaults, options);
    ...
    function setGrouping(groupingInfo) {
      if (!options.groupItemMetadataProvider) {
        options.groupItemMetadataProvider = new core.Data.GroupItemMetadataProvider();
      }
    ...
    function syncGridSelection(grid, preserveHidden, preserveHiddenOnSelectionChange) {
      ...
      var onSelectedRowIdsChanged = new core.Event();
